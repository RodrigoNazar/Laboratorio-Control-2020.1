...
#         self.Piscina = pygame.draw.rect(self.background, self.colorAgua,
#                                         self.posPiscina)  # rect: (x1, y1, width, height)
#         self.PiscinaB = pygame.draw.rect(self.background, self.colorBorde, self.posPiscina,
#                                          4)  # rect: (x1, y1, width, height)
#
#         # Tank1
#         self.posTank1 = (170, 250, 70, 120)
#         self.Tank1B = pygame.draw.rect(self.background, self.colorBorde, self.posTank1,
#                                        4)  # rect: (x1, y1, width, height)
